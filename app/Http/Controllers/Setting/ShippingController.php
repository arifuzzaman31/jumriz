...
class ShippingController extends Controller
{
	...
	public function setVatGstStatus()
    {
    	$result = ShippingCost::find(1);
    	if($result->vat_gst_status == 1){
    		$result->vat_gst_status = 0;
    		$message = 'VAT/GST Deactivated!';
    	} else {
    		$result->vat_gst_status = 1;
			$message = 'VAT/GST Activated Successfully!';
    	}
		$result->update();
		return response()->json(['status' => 'success', 'message' => $message]);
    }
