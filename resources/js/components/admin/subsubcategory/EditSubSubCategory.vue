                ...
                <div class="modal-body">
                    <div class="row">
                        ...
                        <div class="col-sm-8 b-r">
                            <h3 class="m-t-none m-b">Update Sub Sub Category</h3>
                            ...
                            <form @submit.prevent="save" role="form">
                                ...
                                <div class="form-group">
                                    ...
                                    <select v-model="subcategory.category" class="form-control" @change="getSubCategoriesByCategory" required>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="fileinput fileinput-new" data-provides="fileinput">
                                        <span class="btn btn-block btn-primary btn-file">
                                            <span class="fileinput-new"><i class="fa fa-camera"></i> Change Icon</span>
...
const fetchSubSubCategoryData = (id) => {
    axios.get(`${base_url}admin/sub-sub-category/${id}/edit`)
        ...
        .catch(error => {
            console.error('Error fetching sub sub category data:', error);
        });
};
...
const save = async () => {
    ...
    try {
        const response = await axios.post(
            `${base_url}admin/sub-sub-category/update/${subcategory.id}`, 
            subcategory
        );
...
const handleEditEvent = (id) => {
    ...
    hideModal(); // hide first to reset bootstrap scroll state if it was open
    setTimeout(() => {
        if (typeof $ !== 'undefined') {
