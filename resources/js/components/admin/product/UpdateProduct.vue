              ...
              <div class="row">
                ...
                <div class="col-md-4">
                  <div class="form-group">
                    ...
                    <span @click="colorModalUpdate()" class="float-right"
                      >Add Color</span
                    >
                    <label>Chose Color</label>
                    <multiselect
                ...
                <div class="col-md-12">
                  <div class="form-group">
                    ...
                    <vue-editor v-model="product.additional_info"></vue-editor>
                  </div>
                </div>
...
export default {
  ...
  methods: {
    ...
    prepareFields() {
      ...
      this.data.append("short_description", this.product.short_description);
      this.data.append("additional_info", this.product.additional_info);
    ...
    getProduct(id) {
      axios.get(base_url + "admin/product/" + id + "/edit").then((response) => {
        ...
        this.product.short_description = response.data.product.short_description;
        this.product.additional_info = response.data.product.additional_info;
