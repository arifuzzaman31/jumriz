<template>
	...
	<div class="banner mt50 row">
			<div  class="col-lg-6" v-for="(value,index) in offers" :key="value.id" v-if="index < 4">
				<div class="bn">
	...
	<div class="row category" v-if="offers.length >= 3">
		<div class="col-md-12 read-more text-center">
			<a :href="url+'offers'" class="button button-md"> View All Offer <i class="lni-arrow-right"></i></a>
		</div>
	</div>
		</div>
</template>
