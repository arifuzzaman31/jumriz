<template>
    <div class="container" id="searchItem">
        <div class="row category">
            <div class="col-md-12">
                <div class="title text-center" v-if="searchProducts.length > 0">
                    <h4 class="mt20">SEARCH RESULT {{ search_keyword }}</h4>
                </div>
                <div
                    class="title text-center mt50 mb30 p10 color-blue br5 text-center"
                    v-if="
                        keyword != '' &&
                ...
                >
                    <h3>
                        No product available 🥺 for keyword
                        <b class="color-red">{{ keyword }}</b>
                    </h3>
                </div>
            </div>
        </div>
        <div class="row offers">
            <div
                class="col-6 col-lg-3 col-sm-4 mb15"
