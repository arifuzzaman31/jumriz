        ...
        <div class="modal-body">
          ...
          <div class="row" v-if="!isLoading">
            <div class="col-lg-12 col-sm-12">
              ...
              <div class="table-responsive" v-if="order.status != 3">
                <table
                  class="table"
                  v-if="trial_product.length > 0 && showTrial"
                >
                  <tr>
                    <th scope="col">Image</th>
                    <th scope="col">Name</th>
                  ...
                  >
                    <td
                      colspan="5"
                      style="text-align: center; font-size: 20px; color: #fff"
                    >
                      Trial Items
                    </td>
                  </tr>

                  <tr v-for="value in trial_product" :key="value.id">
                    <td>
                      <img
                        v-lazy="
                          url +
                ...
                <a
                  v-if="trial_product.length > 0"
                  @click.prevent="showTrial = !showTrial"
                  href=""
                  class="btn theme-background color-white"
                >
    ...
    userOrderDetails() {
      ...
      axios
        ...
        .then((response) => {
          ...
          this.trial_product = response.data.trial_product;
